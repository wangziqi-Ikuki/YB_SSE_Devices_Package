...
def synthesis_atomic_single(
    *,
    ...
    with resources("yb_synthesis_atomic_station_01"):
        # unilab:node_uuid=3e2167ba-13c6-4dce-a5fd-3019fd8e5603
        with group(name="批次初始化与大坩埚上料"):
        ...
        # unilab:node_uuid=77d80b42-9aed-4d1e-9d8d-d4a597a4322d
        with group(name="配方确认与内部扫码称粉加珠"):
        ...
        # unilab:node_uuid=9e80b545-40b9-47f4-b18b-957fabc02bbc
        with group(name="声共振上料与下料"):
        ...
        # unilab:node_uuid=8f2edc22-e4a9-4967-83de-f7ca4c579a32
        with group(name="扫码装瓶与 POST/LOT 后处理"):
        ...
        # unilab:node_uuid=b1ded26a-fb54-4b04-8218-b0cea8a647fa
        with group(name="小坩埚分配与烧结计划"):
        ...
        # unilab:node_uuid=6ad39ac6-735b-44b9-b49f-fc1086bde19a
        with group(name="烧结与出炉"):
